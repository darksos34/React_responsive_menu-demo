        ...
        <>
            ...
            <div className="container-login">
                <div className="card card-container">
                    <div className="header-title">
                        <nav>
                            <SCard img="https://www.moneyunder30.com/wp-content/uploads/2021/10/shutterstock_1489795766.jpg" title="Carptenter" description="Dit is een test card"/>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div className="container-login">
                <div className="card card-container">
                    <div className="header-title">
                        <nav>
                            <SCard img="https://www.moneyunder30.com/wp-content/uploads/2021/10/shutterstock_1489795766.jpg" title="Decorating" description="Dit is een test card"/>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div className="container-login">
                <div className="card card-container">
                    <div className="header-title">
                        <nav>
                            <SCard img="https://www.insia.net/wp-content/uploads/2020/12/vmware-vision-vmworld2019-960x423.png" title="Machine" description="Dit is een test card"/>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div className="container-login">
                <div className="card card-container">
                    <div className="header-title">
                        <nav>
                            <SCard img="https://upload.wikimedia.org/wikipedia/commons/2/25/Linux_Mint_20_Cinnamon.png" title="Linux" description="Dit is een test card"/>
                        </nav>
                    </div>
                </div>
            </div>
